...
class CartPoleEnv(gym.Env):
    ...
    def _step(self, action):
        ...
        xacc  = (temp * self.total_mass) - self.polemass_length * thetaacc * costheta / self.total_mass
        x  = x + self.tau * x_dot
    ...
    def _reset(self):
        self.state = self.np_random.uniform(low=0.0, high=0.0, size=(4,))
        self.steps_beyond_done = None
